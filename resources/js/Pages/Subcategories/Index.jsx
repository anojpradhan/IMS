              ...
              {subcategories.data.length === 0 ? (
                ...
                subcategories.data.map((subcat) => (
                  <tr key={subcat.id} className="hover:bg-gray-50">
                    <td className="border p-3 text-center">{subcat.id}</td>
                    <td className="border p-3">{subcat.name}</td>
                    <td className="border p-3">{subcat.category?.name || '-'}</td>
                    <td className="border p-3 text-center space-x-2">
                      <a
                        href={route('subcategories.edit', subcat.id)}
                      ...
                      <button
                        ...
                        >
                        {deletingId === subcat.id ? 'Deleting...' : 'Delete'}
                      </button>
                    </td>
                  </tr>
                ))
